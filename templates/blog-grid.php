<?php
/**
 * Template Name: Blog Page with Grid Layout
 * 
 * Blog page with grid layout. Use it for creating a blog page to show archives of  most recent posts using grid layout
 */
?>
<?php get_header(); ?>
<!-- put the slider here -->
<section id="content" class="clumanize">
