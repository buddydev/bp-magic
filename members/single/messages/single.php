		...
		<p id="message-recipients" class="clearfix">
			<span class="highlight">
				...
				<?php if ( !bp_get_the_thread_recipients() ) : ?>
					...
					<?php _e( 'You are alone in this conversation.', 'bp-magic' ); ?>

				<?php else : ?>

					<?php printf( __( 'Conversation between %s and you.', 'bp-magic' ), bp_get_the_thread_recipients() ); ?>

				<?php endif; ?>

			</span>

			<a class="button confirm message-delete" href="<?php bp_the_thread_delete_link(); ?>" title="<?php _e( "Delete Message", "bp-magic" ); ?>"><?php _e( 'Delete', 'bp-magic' ); ?></a> &nbsp;
		</p>
			...
			<div class="message-box">
				...
				<div class="message-metadata">
					...
					<div class="avatar-box">
						...
						<strong><?php _e( 'Send a Reply', 'bp-magic' ); ?></strong>
					</div>
				...
				<div class="message-content">
					...
					<div class="submit">
						<input type="submit" name="send" value="<?php _e( 'Send Reply', 'bp-magic' ); ?>" id="send_reply_button"/>
					</div>
