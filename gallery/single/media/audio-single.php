		...
		<?php if(bp_gallery_has_medias()):?>
			...
			<br class="clear" />
				...
				<?php if(bp_media_is_remote ()):?>
                                        ...
                                        <?php else:
                                            $size= gallery_get_media_size_settings();
                                            ?>
                                        <audio src="<?php bp_media_full_src()?> " type="audio/<?php echo gallery_get_file_extension_from_media(bp_get_the_media());?>" width="<?php echo $size['larger']['width'];?>"  > </audio>
                                       <?php endif;?>
